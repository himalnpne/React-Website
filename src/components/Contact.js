    ...
    <main className="contact-container">
      ...
      {status !== 'success' ? (
        <form onSubmit={handleSubmit} className="contact-form">
          ...
          {/* Social Links Card - Below Privacy Policy */}
          <div className="social-card">
            <div className="social-card-content">
              <h4 className="social-card-title">Connect directly on messaging apps:</h4>
              <div className="social-icons-container">
                <a
                  href="https://discord.com/users/840618599353417738"
                  target="_blank"
                ...
                <a 
                  href="https://signal.me/#eu/TXMDKP0cwDqAYa4TemME17dk_qORav7Z24ZxCcUAioUtERRn7s9Ii563ZlWt6mLs" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="social-icon-link signal"
                  title="Signal"
                >
                  <div className="social-app-icon">
                    <i className="fab fa-signal-messenger"></i>
                  </div>
                </a>
                
                <a 
                  href="https://t.me/himalnpne" 
                  target="_blank" 
                  rel="noopener noreferrer" 
              ...
              <p className="social-card-note">app needs to be installed</p>
            </div>
          </div>
        </form>
      ) : (
