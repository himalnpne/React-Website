...
function Header() {
  ...
  const navItems = [
    ...
    { name: 'Support Me', path: '/support' }, // Added Support Me
          ...
          <div className="menu-section contact-section">
            ...
            <div className="contact-info">
              ...
              <div className="social-links">
                <a
                  href="https://github.com/himalnpne"
                  target="_blank"
                ...
                <a
                  href="https://www.behance.net/hmlnpan"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="social-link"
                  aria-label="Behance"
                ...
                <a
                  href="https://www.instagram.com/himal_npne"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="social-link"
